...
//        holder.rvRating.rating = currentItem.Rating
    ...
    class ViewHolderClass(itemView: View):RecyclerView.ViewHolder(itemView) {
        //        val rvRating:RatingBar = itemView.findViewById(R.id.ratingsBar)
        val rvName:TextView = itemView.findViewById(R.id.ratingName)
        val rvDate:TextView = itemView.findViewById(R.id.ratingDate)
        val rvReview:TextView = itemView.findViewById(R.id.ratingComments)
    }
}